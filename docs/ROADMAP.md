...
| **4** | Wi-Fi + web dashboard | AP + STA, REST + SSE, `web/` (Vite + React + TS) SPA with all sections, admin token, live stream + preview | phone configures everything over Wi-Fi, no cloud | planned |
